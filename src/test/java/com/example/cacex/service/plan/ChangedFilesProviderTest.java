...
class ChangedFilesProviderTest {
    ...
    void returnsEmptyListWhenEnvMissing() {
        ChangedFilesProvider provider = new ChangedFilesProvider(__ -> null);
    ...
    void returnsEmptyListWhenEnvBlank() {
        ChangedFilesProvider provider = new ChangedFilesProvider(__ -> "   ");
    ...
    void parsesAndSanitizesChangedFilePathsFromEnv() {
        ChangedFilesProvider provider = new ChangedFilesProvider(__ -> "\"changedfiles/foo.json\" changedfiles\\bar.json");
